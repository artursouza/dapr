...
We're happy to announce the release of Dapr 0.12.0!
...
See [this](#upgrading-to-dapr-0.12.0) section on upgrading Dapr to version 0.12.0.

## New in this release

### Dapr Runtime

- **ADD** Testing automated release note.

- **Update** Testing release note.

### Dapr CLI

- **Upgrade** Golang Lint to 1.30.0

## Upgrading to Dapr 0.12.0
...
Wait for the update to finish,  ensure you are using the latest version of Dapr(0.12.0) with:
...
* Updating Dapr control plane pods
  * Using the certs exported above, run the following command:
    ```
    helm upgrade dapr dapr/dapr --version 0.12.0 --namespace dapr-system --reset-values --set-file dapr_sentry.tls.root.certPEM=./certs/ca.crt --set-file dapr_sentry.tls.issuer.certPEM=./certs/issuer.crt --set-file dapr_sentry.tls.issuer.keyPEM=./certs/issuer.key
    ```
  ...
  * Verify the control plane is updated and healthy:
    ...
    dapr-dashboard         dapr-system  True     Running  1         0.3.0    15s  2020-10-03 13:07.39
    dapr-sidecar-injector  dapr-system  True     Running  1         0.12.0   15s  2020-10-03 13:07.39
    dapr-sentry            dapr-system  True     Running  1         0.12.0   15s  2020-10-03 13:07.39
    dapr-operator          dapr-system  True     Running  1         0.12.0   15s  2020-10-03 13:07.39
    dapr-placement         dapr-system  True     Running  1         0.12.0   15s  2020-10-03 13:07.39
    ```
...
After Dapr 0.12.0 has been installed, perform a rolling restart for your deployments to pick up the new version of the sidecar.
